package com.example.ProjNotaFiscalLanHouseInfnet.rabbitmq;

import com.example.ProjNotaFiscalLanHouseInfnet.model.NotaFiscal;
...
public class NotaFiscalConsumer {
    ...
    public void receive(@Payload String message){
        try {
            ...
            log.info("Processand Nota Fiscal: {}", notaFiscal);
            Thread.sleep(3000);
        ...
        log.info("NotaFiscalConsumer received message: {}", message);
    }
}
